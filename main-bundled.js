...
var avatarQuestionScreenContent = [{
  ...
  telugu: "Share the Thala magic",
  //done
  tamil: "Share the Thala magic",
  //done
  kannada: "Share the Thala magic" //done
}, {
  english: "Download",
  telugu: "డౌన్‌లోడ్",
  //done
  ...
  telugu: "మీ కాల్ ముగిసింది",
  //done
  tamil: "அழைப்பு முடிந்தது",
  //done
  kannada: "ಕಾಲ್ ಮುಕ್ತಾಯವಾಗಿದೆ " //done
}, {
  english: "proceed to next section",
  telugu: "ధోనితో మాట్లాడటం మీకు మజాగా అనిపించింది అని ఆశిస్తున్నాం",
  //done
  tamil: "தோனியுடன் பேசியதற்கு நம்புகிறோம் மகிழ்ந்திருப்பீர்கள் ",
  //done
  kannada: "ಧೋನಿಯೊಂದಿಗೆ ಮಾತುಕತೆ ಆಸಕ್ತಿದಾಯಕವಾಗಿತ್ತೆಂದು ಆಶೆ" //done
}, {
  english: "Proceed",
  telugu: " కొనసాగించండి… ",
  //done
